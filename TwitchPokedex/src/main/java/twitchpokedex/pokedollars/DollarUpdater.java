...
public class DollarUpdater
{
	...
	{
		if (!updatingUsers.contains(newUser))
			updatingUsers.add(newUser);
	}
	...
	public static void StartUpdating()
	{
		...
		updatingTimer.scheduleAtFixedRate(new DollarUpdateTask(), 0,
				Integer.parseInt(DBConn.GetSetting("PointTimer")));
	}
